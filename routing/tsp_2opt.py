...
print '2-opt on the Random Nearest Neighbor Tour'
to_cycle = to.TwoOptCycle(G1, nns.NearNeighCycle(G1,1))

print '2-opt on the Farthest Insertion Tour'
tof_cycle = to.TwoOptCycle(G1, fi_cycle)
